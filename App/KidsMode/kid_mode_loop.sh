...
# max volume/brightness ceilings, toggle auto-resume, or change the PIN.
# "Add play time" is an inline value selector on the menu row itself
# (LEFT/RIGHT to pick 5-120 min, A/START to apply). Value rows report the
